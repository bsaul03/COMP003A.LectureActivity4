 ...
 * Reference: https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/iteration-
statements
*/
...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /*
             * The for statement: executes its body while specified Boolean expression evaluates to true.
             * there are 3 parts in the for loop statment
            ...
            Console.WriteLine("".PadRight(50, '*'));
            /*
             * The do statment executes a statement or a block of statements while a specified
             * Boolean expressions evaluate to true. Because that expression is evaluated after
